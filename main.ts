...
function asteroidMap () {
    tiles.placeOnTile(duck, tiles.getTileLocation(1, 1))
    ...
    tiles.placeOnTile(sprites.create(img`
        ...
        . . . e e e e e e e e . . . . . 
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.level2), tiles.getTileLocation(8, 28))
}
...
function forestMap () {
    ...
    tiles.placeOnTile(sprites.create(img`
        ...
        41554eede.......................
        44ee...4e.......................
        `, SpriteKind.level1), tiles.getTileLocation(8, 30))
}
function moveMobs () {
    for (let value of mobs) {
        value.setVelocity(10 * randint(-1, 1) + 10, value.y)
    }
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.level2, function (sprite, otherSprite) {
    game.over(true)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.level1, function (sprite, otherSprite) {
    asteroidMap()
})
...
function spawnMob () {
    mob = sprites.create(img`
        ...
        .............fffff..............
        `, SpriteKind.Enemy)
    tiles.placeOnRandomTile(null, assets.tile`transparency16`)
    mob.setStayInScreen(true)
    mobs.push(mob)
}
let mob: Sprite = null
let mobs: Sprite[] = []
